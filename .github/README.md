...
[`@aws-sdk/client-efs`](https://www.npmjs.com/package/@aws-sdk/client-efs/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PUXR2F22nw2RGCR3huZTozEQrApu4v2p5V4V+VN60H/9apLm2dK6qs4R0ZeUO3kN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-efs": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.804.0/index.min.mjs": "sha384-PUXR2F22nw2RGCR3huZTozEQrApu4v2p5V4V+VN60H/9apLm2dK6qs4R0ZeUO3kN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-efs/blob/refs/tags/3.804.0/LICENSE
```
