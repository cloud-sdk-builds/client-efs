...
[`@aws-sdk/client-efs`](https://www.npmjs.com/package/@aws-sdk/client-efs/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xY+/r7Uddf4vciadMAfxPNCeH6gwI+v9DClPC4eIjbODbonvYOXbXMXh3HY1hbRD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-efs": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-efs@3.556.0/index.min.mjs": "sha384-xY+/r7Uddf4vciadMAfxPNCeH6gwI+v9DClPC4eIjbODbonvYOXbXMXh3HY1hbRD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-efs/blob/refs/tags/3.556.0/LICENSE
```
